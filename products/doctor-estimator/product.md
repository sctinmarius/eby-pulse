...
Doctor Estimator (doctorestimator.ro) este o aplicație web pentru medicii din România
care colaborează cu una sau mai multe clinici. Înlocuiește Excel-ul, agenda de hârtie
și pozele cu programări trimise pe WhatsApp cu un singur loc în care medicul își vede
programul, procedurile și veniturile.

## Funcționalități și beneficiile lor

- **Vizibilitatea veniturilor per clinică** — medicul știe în orice moment cât a
  încasat în fiecare clinică, fără calcule de sfârșit de lună în Excel.
...
- **Calendar unificat** — toate clinicile într-un singur calendar, fără suprapuneri.
- **Proceduri cu prețuri și notițe** — fiecare procedură are preț, durată, status și
  observații atașate.
- **Dashboard cu indicatori** — proceduri programate/finalizate, venit brut,
  acuratețea estimărilor, venit pe oră reală/estimată, defalcat pe clinică.
